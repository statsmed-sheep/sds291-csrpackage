...
3. newchild_factor (whether or not the person has had a new child in the past year)

4. diffmob_factor (whether or not an individual has mobility difficulties)

5. stem_factor (whether or not an individual works in a STEM field)

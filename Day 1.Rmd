...
The ANOVA's p-value is <2.2e-16, indicating that the second model including the interaction term between age and race describes signifciantly more variation in commute time than the model excluding it.

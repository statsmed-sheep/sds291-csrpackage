...
```{r}
usa_data2<-usa_data2 %>% 
  select("AGE", "race_factor", "TRANTIME", "newchild_factor", "SERIAL", "diffmob_factor", "stem_factor") # %>% 
  # mutate(diffmob_factor = ifelse(diffmob_factor == "No independent living difficulty", "No", "Yes"))
```
...
>>>>>>> 1f51b0afb1b761d08b8569d56f94fdcbb9d210b4
summary(m2)
```

...
In order to analyze our primary hypothesis based on our nested model (log(BMI) =0 + 1HRSLEEP + 'X), we performed a t-test for the HRSLEEP coefficient with the hypotheses
$H_0: \beta_1 = 0$

...
$log(BMI) = \beta_0 + \beta_1 \cdot HRSLEEP + \beta_2 \cdot worfreq_binary + \beta_3 \cdot (HRSLEEP \cdot worfreq_binary) +\beta'X$
...
log(BMI) = \beta_0 + \beta_1 \cdot HRSLEEP + \beta_2 \cdot worfreq\_binary +

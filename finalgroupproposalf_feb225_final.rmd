...
7. Physical activity will be controlled for, but the specific variable we're going to use has yet to be determined.
8. We think nutrition is an important variable to control for, but we are still figuring out how to do this because we cannot find a variable that summarizes nutrition well. We may have to construct our own.

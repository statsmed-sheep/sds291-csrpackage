...
After some initial data wrangling, our data set has 9 variables and 19925 variables. The variables are:
...
5. activity_score is a variable we creating, and is a number that represents a person's activity level.

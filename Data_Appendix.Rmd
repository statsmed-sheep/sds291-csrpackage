...
Based on the previous scatterplots faceted by race, we decided to combine Asian ethnicities and keep Alaskan Native or American Indians separate. We also recoded each categorical variable as a binary variable.
